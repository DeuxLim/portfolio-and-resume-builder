...
export default function PortfolioMiniPreview({ large = false }: { large?: boolean }) {
	const viewportClass = large ? "h-[25rem] sm:h-[44rem]" : "h-64 sm:h-80";
	const scaleClass = large ? "scale-[0.3] sm:scale-[0.44]" : "scale-[0.23] sm:scale-[0.34]";
